...
namespace _03022017
{
    public partial class TimerWindow : Form
    {
        ...
        private string labelTimerValue ;
        ...
        private void OnDateTimePickerValueChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show((string.Format("{0}\n\n{1}\n\n{2}\n\n{3}", labelLeftDays.Text, labelLeftHours.Text,
                labelLeftMinutes.Text, labelLeftSeconds.Text)), labelLeft.Text, MessageBoxButtons.OK
